...
\mainbar{
    ...
    \project{SkillFlyer: A Crowd-Sourced Learning Platform}{}{
    -Takes YouTube videos and ranks them through crowd sourcing by a variety of educational topics and subtopics\\
    -Uses MongoDB as the data backend, NodeJS as the serving backend, and ReactJS as the frontend}
